// SnakeArcade.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void RenderGameGrid(const GameConfig& cfg, int playerX, int playerY)
{
    system("cls");
    std::cout << "\n";
    ...
    while (running)
    {
        ...
        switch (state)
        {
            ...
            case GameState::Playing:
            {
                ...
                while (playing)
                {
                    RenderGameGrid(cfg, playerX, playerY);
                    ...
                    Vec2 pos{ playerX, playerY };
                    ClampPosition(cfg, pos);
